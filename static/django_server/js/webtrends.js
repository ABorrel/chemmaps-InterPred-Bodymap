...
// Created: 8/17/2017 1:51:14 PM

function WebTrends() {
    var that = this;
    // begin: user modifiable
    this.dcsid = 'dcscvmg9i00000omhjchr4ml1_3v4p';
    this.domain = 'webtrends-sdc.niehs.nih.gov';
    this.timezone = -5;
    this.onsitedoms = '';
...
WebTrends.prototype.dcsIsFpcSet = function(name, id, lv, ss) {
    ...
    if (c) {
        return id == this.dcsGetIdCrumb(c, 'id') &&
            lv == this.dcsGetCrumb(c, 'lv') &&
            ss == this.dcsGetCrumb(c, 'ss')
            ? 0
            : 3;
    }
    return 2;
...
WebTrends.prototype.dcsFPC = function() {
    ...
    if (!this.FPCConfig.enabled && !this.TPCConfig.enabled) this.WT['ce'] = '0';
    else if (this.FPCConfig.enabled && !this.TPCConfig.enabled) this.WT['ce'] = '1';
    else this.WT['ce'] = '2';
    ...
    var expiry = this.FPCConfig.expires
        ? '; expires=' + new Date(new Date().getTime() + this.FPCConfig.expires).toGMTString()
        : '';
    ...
    document.cookie =
        ...
        expiry +
        '; path=/' +
        (this.FPCConfig.domain != '' ? '; domain=' + this.FPCConfig.domain : '');
    ...
    if (evt && (typeof evt.which != 'number' || evt.which == 1)) {
        ...
        if (e.href) {
            ...
            if (this.dcsIsOnsite(hn) && this.dcsTypeMatch(e.pathname, this.downloadtypes)) {
                var qry = e.search
                    ? e.search.substring(e.search.indexOf('?') + 1, e.search.length)
                    : '';
                var pth = e.pathname
        ...
        if (btn != 1 || navigator.userAgent.indexOf('Safari') != -1) {
            ...
            if (typeof e.href != 'undefined' && e.href) {
                if (
                    ...
                    if (
                        typeof e.pathname != 'undefined' &&
                        this.dcsTypeMatch(e.pathname, this.downloadtypes)
                    ) {
                        var pth = e.pathname
                            ? e.pathname.indexOf('/') != 0 ? '/' + e.pathname : e.pathname
                            : '/';
        ...
        if (e.href) {
            ...
            if (hn.length > 0 && pr.indexOf('http') == 0 && !this.dcsIsOnsite(hn)) {
                ...
                this.dcsMultiTrack(
                    ...
                    pth,
                    'DCS.dcsqry',
                    this.trimoffsiteparams ? '' : qry,
                    'DCS.dcsref',
                    window.location,
                    'WT.ti',
                    'Offsite:' + hn + pth + (qry.length ? '?' + qry : ''),
                    'WT.dl',
                    '24',
                    'WT.nv',
                    this.dcsNavigation(evt)
...
WebTrends.prototype.dcsVar = function() {
    ...
    if (document.title) {
        if (window.RegExp) {
            var tire = new RegExp(
                '^' + window.location.protocol + '//' + window.location.hostname + '\\s-\\s'
            );
    ...
    if (DCS.dcsqry) {
        ...
        var params = this.paidsearchparams.length
